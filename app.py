...
def run_streamlit_dashboard():
    ...
    /* Main page background — soft light green */
    .stApp {
    ...
    /* All body text — dark olive green for readability */
    ...
    .stApp h1 { color: #1a3d1a !important; font-weight: 700 !important; }
    .stApp h2 { color: #2E7D32 !important; font-weight: 600 !important; }
    .stApp h3 { color: #388E3C !important; font-weight: 600 !important; }

    /* ── SIDEBAR ─────────────────────────────────────────────── */
    [data-testid="stSidebar"] {
        background: linear-gradient(180deg, #1a3d1a 0%, #2d5a1b 40%, #4a7c2f 100%) !important;
    }
    [data-testid="stSidebar"] * {
