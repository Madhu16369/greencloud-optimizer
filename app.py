...
def run_streamlit_dashboard():
    ...
    /* ══════════════════════════════════════════════════════
       GREENCLOUD OPTIMIZER — GREEN THEME  (full contrast)
    ══════════════════════════════════════════════════════ */

    /* PAGE BACKGROUND */
    .stApp { background-color: #eaf4ea !important; }
    ...
    /* Targets Streamlit's h1 rendered by st.title */
    .stApp h1,
    ...
    label { color: #1a3d1a !important; font-weight: 500 !important; }
    ...
    [data-testid="stSidebar"] .stRadio label { color: #d4edda !important; font-size: 14px !important; font-weight: 500 !important; }
    [data-testid="stSidebar"] [data-testid="stMarkdownContainer"] p,
    [data-testid="stSidebar"] [data-testid="stMarkdownContainer"] li { color: #b8ddb8 !important; font-size: 13px !important; }
    ...
    /* ── EXPANDERS — fix dark header bg + invisible text ── */
    /* Override the dark header Streamlit renders for expanders */
    [data-testid="stExpander"] {
        background: #ffffff !important;
        border: 1.5px solid #b2dfb2 !important;
        border-radius: 12px !important;
    ...
    [data-testid="stExpander"] details summary {
        background: #d0ead0 !important;
        border-radius: 10px 10px 0 0 !important;
        padding: 14px 18px !important;
    }
    [data-testid="stExpander"] details[open] summary {
        border-bottom: 1.5px solid #b2dfb2 !important;
        border-radius: 10px 10px 0 0 !important;
    }
    /* Summary text — dark green, bold, large enough to read */
    ...
    [data-testid="stInfo"] span { color: #1a3d1a !important; font-weight: 500 !important; }
    [data-testid="stSuccess"]   { background: #f1f8e9 !important; border-left: 4px solid #7CB342 !important; }
    [data-testid="stWarning"]   { background: #fff9e6 !important; border-left: 4px solid #F9A825 !important; }
    ...
    [data-testid="stSlider"] label { color: #1a3d1a !important; font-weight: 600 !important; }
    ...
    .stTabs [data-baseweb="tab"]     { color: #1a3d1a !important; font-weight: 600 !important; }
    .stTabs [aria-selected="true"]   { background: #2E7D32 !important; color: #ffffff !important; border-radius: 7px !important; }

    /* ── DIVIDER / HR ────────────────────────────────── */
    hr { border-color: #b2dfb2 !important; opacity: 1 !important; }

    /* ── TOP TOOLBAR ─────────────────────────────────── */
    header[data-testid="stHeader"] { background: #0d2b0d !important; }
    header[data-testid="stHeader"] button svg { fill: #c8e6c9 !important; }
